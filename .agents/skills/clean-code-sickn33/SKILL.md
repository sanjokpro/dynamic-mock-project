---
name: clean-code-sickn33
description: "Clean Code (Robert C. Martin) principles: intention-revealing names, small single-responsibility functions, comment discipline, Law of Demeter, exception-based error handling, TDD. Variant distillation sourced via sickn33/agentic-awesome-skills (upstream ClawForge). Use alongside or instead of the clean-code skill."
---
